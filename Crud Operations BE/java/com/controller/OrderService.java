...
public class OrderService {
	...
	public List customerData(Customer customer) {
		...
		if (!customer.getPassword().isEmpty() && customer.getPassword() != null && !"".equals(customer.getEmail())) {
			...
			String query = "SELECT customer.name, customer.email,mobiles.mobileid,mobiles.mobilename,mobiles.provider,mobiles.quantity,mobiles.price,customer.id,mobiles.common "
